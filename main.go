...
func main() {
	exampleName := flag.String("example-name", "swaggerExample", "Top-level key name for the Swagger example block")
	schemaName := flag.String("schema-name", "swaggerSchema", "Top-level key name for the Swagger schema block")
